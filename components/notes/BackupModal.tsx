...
export function BackupModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={o => !o && onClose()}>
      <DialogContent className="bg-card border-border text-card-foreground max-w-md mx-4">
        <DialogHeader>
        ...
        <div className="space-y-5 pt-2">
          ...
          {/* Export */}
          <div>
            <p className="text-[10px] font-mono text-text-tertiary uppercase tracking-wider mb-2">Export</p>
            ...
            <div className="flex gap-2">
              <Input type="password" placeholder="Backup password" value={exportPassword}
                ...
                className="bg-surface-inset border-border text-foreground text-[12px] flex-1" />
              <Button onClick={handleExport}
                className="bg-primary text-primary-foreground hover:opacity-90 text-[12px] shrink-0">
                Download
              </Button>
            </div>
          </div>
          ...
          {/* Import */}
          <div>
            <p className="text-[10px] font-mono text-text-tertiary uppercase tracking-wider mb-2">Import</p>
            <p className="text-[11px] text-text-tertiary mb-3 leading-relaxed">
            ...
            <div className="space-y-2">
              <Input type="password" placeholder="Backup password" value={importPassword}
                ...
                className="bg-surface-inset border-border text-foreground text-[12px]" />
              <label className="flex items-center justify-center w-full border border-border rounded-md py-2.5 text-[12px] text-text-tertiary hover:text-text-secondary hover:border-border-strong transition-colors cursor-pointer">
            ...
            {importError && <p className="text-[11px] text-destructive mt-2">{importError}</p>}
          ...
          {canSync && (
            <>
              <div className="border-t border-border" />
              <div>
                <p className="text-[10px] font-mono text-text-tertiary uppercase tracking-wider mb-2">Auto-Sync</p>
                <p className="text-[11px] text-text-tertiary mb-3 leading-relaxed">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-[12px] text-text-secondary">Enable auto-sync</span>
                  </label>
